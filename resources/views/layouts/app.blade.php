...
<head>
    ...
    <title>@yield('title', 'Thuê Xe HD - Dịch vụ cho thuê xe uy tín')</title>
    <meta name="description" content="@yield('description', 'Thuê Xe HD cung cấp dịch vụ cho thuê xe chất lượng cao với giá cả hợp lý. Xe đời mới, tài xế chuyên nghiệp, phục vụ 24/7.')">
...
<body class="font-sans antialiased bg-gray-50">
    ...
    <header class="fixed top-0 left-0 right-0 z-50 transition-all duration-300" id="header">
        <nav class="navbar-scroll border-b border-gray-200">
                ...
                <div class="flex justify-between items-center h-16">
                    ...
                    <div class="flex items-center">
                        <a href="{{ route('home') }}" class="flex items-center space-x-3">
                            ...
                            <div>
                                <h1 class="text-xl font-bold text-gray-900">Thuê Xe HD</h1>
                                <p class="text-xs text-gray-600">Dịch vụ cho thuê xe chuyên nghiệp</p>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        <a href="{{ route('home') }}" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Trang chủ</a>
            ...
            <div class="md:hidden hidden" id="mobile-menu">
                <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200">
                    <a href="{{ route('home') }}" class="block px-3 py-2 text-gray-700 hover:text-blue-600 font-medium">Trang chủ</a>
                    ...
                    <div class="px-3 py-2">
                        ...
                        <a href="{{ route('booking') }}" class="btn-primary text-white px-6 py-2 rounded-lg font-medium inline-block">
                            Đặt xe ngay
                        </a>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="lg:col-span-1">
                    <div class="flex items-center space-x-3 mb-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold">Thuê Xe HD</h3>
                            <p class="text-sm text-gray-300">Dịch vụ cho thuê xe chuyên nghiệp</p>
                        </div>
                    </div>
                    <p class="text-gray-300 text-sm mb-4">
                        Chúng tôi cung cấp dịch vụ cho thuê xe chất lượng cao với đội ngũ tài xế chuyên nghiệp và xe đời mới.
                    </p>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="{{ route('home') }}" class="text-gray-300 hover:text-white transition-colors">Trang chủ</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Thuê xe du lịch</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Thuê xe cưới hỏi</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Thuê xe sân bay</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Thuê xe theo giờ</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Thuê xe dài hạn</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <p class="text-gray-300 text-sm">123 Đường ABC, Quận XYZ</p>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-gray-300 text-sm">Email: info@thuexeHD.com</p>
                            </div>
                        </div>
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="text-gray-300 text-sm">Thứ 2 - Chủ nhật</p>
                                <p class="text-gray-300 text-sm">24/7 phục vụ</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="border-t border-gray-600 mt-8 pt-8">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    <div class="text-gray-300 text-sm mb-4 md:mb-0">
                        © {{ date('Y') }} Thuê Xe HD. Tất cả quyền được bảo lưu.
                    </div>
                    <div class="flex space-x-6 text-sm">
                        ...
                        <a href="#" class="text-gray-300 hover:text-white transition-colors">Chính sách hoàn tiền</a>
                    </div>
                </div>
            </div>
        </div>
