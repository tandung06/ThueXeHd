    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
            <div class="flex items-center justify-center space-x-2 mb-4">
                ...
                <span class="text-3xl font-bold text-gray-800">Lali</span>
            </div>
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center">
                            <input id="role_renter" 
                                   name="role" 
                                   type="radio" 
                                   value="renter" 
                                   {{ old('role') == 'renter' ? 'checked' : '' }}
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                            <label for="role_renter" class="ml-3 block text-sm text-gray-700">
                                <span class="font-medium">Thuê sản phẩm</span>
                                <span class="text-gray-500 block">Tìm và thuê sản phẩm từ người khác</span>
                            </label>
                        </div>
                        <div class="flex items-center">
                            <input id="role_owner" 
                                   ...
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                            <label for="role_owner" class="ml-3 block text-sm text-gray-700">
                                <span class="font-medium">Cho thuê sản phẩm</span>
                                <span class="text-gray-500 block">Đăng sản phẩm để cho người khác thuê</span>
                            </label>
                        </div>
                        <div class="flex items-center">
                            <input id="role_both" 
                                   ...
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                            <label for="role_both" class="ml-3 block text-sm text-gray-700">
                                <span class="font-medium">Cả hai</span>
                                <span class="text-gray-500 block">Vừa thuê vừa cho thuê sản phẩm</span>
                            </label>
                        </div>
                    </div>
                    @error('role')
